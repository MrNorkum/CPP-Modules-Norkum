...
/*                                                                            */
/*   Created: 2024/01/17 08:31:54 by Mr. Norkum                               */
/*   Updated: 2024/01/17 08:31:56 by Mr. Norkum                               */
/*                                                                            */
/* ************************************************************************** */
...
/*                             Setters and Getters                            */
/*                                                                            */
/*   ->void    ClapTrap::setName(const string name) const;                    */
/*   ->void    ClapTrap::setHitPoints(unsigned int hitPoints) const;          */
/*   ->void    ClapTrap::setEnergyPoints(unsigned int energyPoints) const;    */
...
{
	this->_name = name;
	if (this->_name == "" || this->_name == "(unknown_clap_name)")
	{
...
{
	this->_hitPoints = hitPoints * !(getName() == "" || getName() == "(unknown_clap_name)");
	if (!this->_hitPoints)
		setEnergyPoints(0);
}
